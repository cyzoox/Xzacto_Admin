...
const StoreFFScreen = ({ navigation, route }) => {
    ...
    <View  style={{flex:1}}>
      ...
      <View>
        <View style={styles.actualCapital}>
          <View>
              <Text style={{color: colors.white, fontWeight:'900', fontSize: 17, color: colors.accent, fontWeight:'700'}}>Actual Capital</Text>
          </View>
        ...
        <View style={styles.capitalStocks}>
          <View>
              <Text style={{color: colors.white, fontWeight:'900', fontSize: 17, color: colors.accent, fontWeight:'700'}}>Capital of Stocks in Store</Text>
          </View>
          <View style={{flexDirection:'row', justifyContent:'flex-end'}}>
...
StoreFFScreen.navigationOptions = () => {
  return {
    headerShown: false
  };
}
