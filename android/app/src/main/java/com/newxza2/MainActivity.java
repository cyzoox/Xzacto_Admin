...
public class MainActivity extends ReactActivity {
  ...
  public void onCreate(Bundle saved) {
   ...
   public void initiateSplash() {
        ...
        AddImageView logoimage = new AddImageView(R.drawable.logo2, screenHeight * 0.24, screenWidth * 0.4, AddImageView.getCenterX(screenWidth * 0.41), AddImageView.getCenterY(screenHeight * 0.26), AddImageView.FIT_XY, false);
